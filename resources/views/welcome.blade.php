                    ...
                    <div class="w-screen mx-auto"> <!-- Cambié de w-full a w-screen para tomar el ancho completo de la pantalla -->
                        <div id="default-carousel" class="relative overflow-hidden shadow-lg" data-carousel="static">
                            ...
                            <div class="h-80 md:h-50 w-full" data-carousel-inner>
                                ...
                                <!-- Item 2 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="https://img.freepik.com/fotos-premium/sushi-fondo-negro_911620-2823.jpg"
                                        class="object-cover w-full h-full" alt="Slide 2">
                                       {{--  <span class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl font-regular text-white md:text-2xl dark:text-gray-800">Texto II de imagen de Banner</span> --}}
                                </div>
                                <!-- Item 3 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="https://img.freepik.com/fotos-premium/sushi-fondo-negro_911620-2844.jpg"
                                        class="object-cover w-full h-full" alt="Slide 3">
                                        {{-- <span class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl font-regular text-white md:text-2xl dark:text-gray-800">Texto III de imagen de Banner</span> --}}
                                </div>
                            </div>
                            <!-- Slider indicators -->
